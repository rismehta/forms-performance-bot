...
export class FormPRReporter {
  ...
  buildMarkdownReport(results, urls) {
    ...
    // Performance Metrics (load time from browser rendering)
    if (urls.beforeData?.performanceMetrics || urls.afterData?.performanceMetrics) {
      sections.push(this.buildPerformanceMetricsSection(urls.beforeData, urls.afterData));
    }
