...
export class FormPRReporter {
  ...
  buildMarkdownReport(results, urls, prNumber, repo) {
    ...
    if (urls.gistUrl) {
      // Gist available - direct browser viewing
      sections.push(`**[View Full Report (Interactive)](${urls.gistUrl})** — Opens in browser with all 200+ checks\n`);
      sections.push(`**[Download Report](${artifactUrl})** (Artifact) | **[Action Logs](${artifactUrl})** | **[Documentation](https://github.com/rismehta/forms-performance-bot)**\n`);
    } else {
      // Fallback to artifact download
      sections.push(`**[View Full Report →](${artifactUrl})** — Click "Summary" → Download "performance-report" artifact\n`);
      sections.push(`**[Action Logs](${artifactUrl})** | **[Documentation](https://github.com/rismehta/forms-performance-bot)**\n`);
    }
